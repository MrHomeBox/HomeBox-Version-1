    ...
    bodyContent = (
      <div className="flex flex-col gap-8">
        <Heading
          ...
          subtitle="Help users guests find you!"
        />
        <CountrySelect 
          value={location} 
    ...
    bodyContent = (
      <div className="flex flex-col gap-8">
        ...
        <Counter 
          ...
          value={bathroomCount}
          title="Bathrooms" 
          subtitle="How many maximum people per room or service?"
        />
      </div>
    )
  }
    ...
    bodyContent = (
      <div className="flex flex-col gap-8">
        <Heading
          ...
          subtitle="Show guests what your service looks like!"
        />
        <ImageUpload
